<?php 
 $GLOBALS["dictionary"]["key2_students"]=array (
  'table' => 'key2_students',
  'audited' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'key2_students_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'key2_students_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'key2_students_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'key2_students_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'key2_students_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'key2_students_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'key2_students_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'key2_students_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'key2_students_assigned_user',
  ...
  array (
    ...
    'key2_students_team_count_relationship' => 
    array (
      'lhs_module' => 'Teams',
      'lhs_table' => 'team_sets',
      'lhs_key' => 'id',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_key2_students_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_key2_students_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_key2_students_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'team_set_key2_students' => 
    array (
      'name' => 'idx_key2_students_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_key2_students_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'deleted',
